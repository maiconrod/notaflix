...
const MovieCard = ({ movie, showLink = true }) => {
  ...
  return (
    ...
    className="p-2 pb-4 mx-3 grid rounded-lg bg-gradient-to-t border border-gray-500">
        <img
          src={imageUrl + movie.poster_path}
          alt={movie.title}
          className="mb-3 m-2 max-w-60 sm:max-w-48 md:max-w-48 lg:max-w-64 rounded-lg"
        />
